...
/**
 * @fn void HMI::KNOB::init(TIM_TypeDef * __restrict__ pu32TIM)
 *
 * @details
 *
 */
...
{
  button.init(KNOB_BUTTON_PORT, KNOB_BUTTON_PIN);
...
/**
 * @fn int8_t HMI::KNOB::readDirection(void)
 *
 * @details
 *
 * @return
 */
int8_t HMI::KNOB::readDirection(void)
{
  static volatile int32_t temp_data = ((*position) >> 1);	/** div2 | done once */
