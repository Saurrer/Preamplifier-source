...
volatile uint8_t led_table[6][8];
...
WS2812B::DMA_peripheral_conf(DMA_Channel_TypeDef * pDMA_Channel)
{
  ...
  DMA_set_number_of_data_to_transfer(pDMA_Channel, 6*8);
...
{
  DMA2_Channel1->CCR |= DMA_CCR_EN;		/**< reset buffer to default value */
